...
public class BotWithParamApplier extends AbstractBotHandlerApplier<SendMessage> implements BotApplier<SendMessage> {

    public BotWithParamApplier(List<Object> botHandlers) {
        super(botHandlers);
    }
